      ...
      <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {propertyTypes.map((type) => (
          <button
            ...
            className={`relative flex flex-col items-center rounded-xl border-2 p-6 text-center transition-all hover:border-blue-300 hover:bg-blue-50/50 ${
          ...
          >
            ...
            <h3
              className={`mt-4 text-base font-semibold ${
                selectedType === type.value ? 'text-blue-900' : 'text-slate-900'
              }`}
            >
              {type.label}
            </h3>
            <p
              className={`mt-1 text-sm ${
                selectedType === type.value ? 'text-blue-700' : 'text-slate-600'
              }`}
            >
              {type.description}
            </p>
